...
class DirectoryExplorer
  ...
  parse: (text) =>
    ...
    unless @root
      ...
      if text == '~'..File.separator return DirectoryExplorer.for_path(File.home_dir.path, @_copy_opts!), absolute: true
      -- direct jump to fs root
      if text == File.separator return DirectoryExplorer.for_path(@file.root_dir.path, @_copy_opts!), absolute: true
    ...
    return matched, absolute: true, :remaining_text
